<?php
	...
	$sql_cate = mysqli_query($connect,"SELECT * FROM tbl_category,tbl_sanpham WHERE tbl_category.category_id=tbl_sanpham.category_id AND tbl_sanpham.
	category_id='$id' ORDER BY tbl_sanpham.sanpham_id DESC");

	/* ------------------------------- SELECT SQL different ------------------------------- */
	$sql_category = mysqli_query($connect,"SELECT * FROM tbl_category,tbl_sanpham WHERE tbl_category.category_id=tbl_sanpham.category_id AND tbl_sanpham.
	category_id='$id' ORDER BY tbl_sanpham.sanpham_id DESC");
