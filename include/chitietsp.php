			...
			<div class="row">
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
									<img src="../images/<?php echo $row_chitiet['sanpham_hinhanh'] ?>"  alt="" width="100%" height="500"> </div>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<div class="product-single-w3l">
						<p class=""><?php echo $row_chitiet['sanpham_chitiet']?></p>
                        <br>
						<p class=""><?php echo $row_chitiet['sanpham_mota']?></p>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="?quanly=giohang" method="post">
								<fieldset>
									...
									<input type="hidden" name="hinhanh" value="<?php echo $row_chitiet['sanpham_hinhanh'] ?>" />									
