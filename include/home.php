					...
					<div class="wrapper">
						<?php
							...
							while ($row_cate_home = mysqli_fetch_array($sql_cate_home)) {
								// khai báo id cate để lọc sản phẩm theo theo cate
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<?php
									$sql_sanpham = mysqli_query($connect,"SELECT * FROM tbl_sanpham ORDER BY sanpham_id DESC");
									while ($row_sanpham = mysqli_fetch_array($sql_sanpham)) {
										//câu lệnh if để chọn sản phẩm theo đúng cate
										if($row_sanpham['category_id'] == $id_category) {
								?>
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/<?php echo $row_sanpham['sanpham_hinhanh'] ?>" width="250px" height="220px">
